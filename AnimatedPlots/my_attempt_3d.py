# GOAL: create an animation with a sphere that grows outwards and then inwards (big bang-big crunch style)
...
if __name__ == '__main__':
    perm_matrix = animate_sphere(25, fps=30)
